...
const categories = [
    {
        id: "technology",
        name: "Technology",
        description: "Latest tech news and innovateions",
    },
    {
        id: "business",
        name: "Business",
...
export default function SelectPage(){
    ...
    async function handleSavePreferences(e: FormEvent) {
        ...
        try {
            ...
            alert("Your news letter preferences has been saved. You will start receiving them soon.");
                ...
                >
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mb-6">
                            Select the topics you would  like to see in your personalised newsletter
                        </p>
                        ...
                        {/* display how many checkbox / catategories are selected */}
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mb-6">
                            How often would you liek to receive you newsletter?
                        </p>
                                    ...
                                    <div className="flex items-center h-5">
                                        <div
                                            className={`w-5 h-5 border-2 rounded-full flex items-center justify-center ${
                                                selectedFrequency === frequency.id ?
                                                "border-blue-blue-500 bg-blue-500"
                                                :
                                                "border-gray-300"
                                            }`}
                                        >
